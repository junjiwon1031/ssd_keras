'''
The network is based on ssd_keras, made by Pierluigi Ferrari.
...
def ssd_512_surveillance(image_size,
    ...
    # In Surveillance environment, there are no big objects ( bigger than 1/4 of scene)
    # So original ssd512 has 7 layers, but we only need 5 for detecting
